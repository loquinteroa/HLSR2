...
// import background from './images/solid-gray.jpg';
...
const colors = {
  gradients: {
    blue1: 'linear-gradient(135deg, #00AEEF 0%, #000DFF 100%)',
...
export const PureLightTheme = createTheme({
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        outlinedSecondary: {
          ...
          '&:hover, &.MuiSelected': {
            backgroundColor: colors.alpha.gray[5],
            color: colors.alpha.gray[100]
          }
        },
        sizeSmall: {
          padding: '4px 12px',
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          backgroundColor: alpha(colors.primary.lighter, 0.95),
          padding: '8px 16px',
          fontSize: 12,
          color: "black",
    ...
    MuiInputBase: {
      styleOverrides: {
        root: {
          '&.Mui-focused, &.Mui-active, &.Mui-disabled, &.Mui-selected, .Mui-focusVisible':{
